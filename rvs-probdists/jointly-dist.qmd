...
- From the @tbl-jointex $P(X = 1, Y = 1) = 0.08$
...
## A Important Note on Independence
...
But the reverse is **not necessarily true**. Two variables can have zero covariance (i.e., be uncorrelated) and still be **dependent** in a nonlinear way as mentioned above (but worth repeating!).

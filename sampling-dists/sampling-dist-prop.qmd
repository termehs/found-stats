...
$$
This follows from the fact that the sample proportion $\hat{p}$ can be viewed as a sample mean of binary variables, justifying the use of **Central Limit Theorem** covered in the next chapter.

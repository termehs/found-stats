...
$$
\begin{aligned}
P(X = 0) &= \binom{100}{0} (0.04)^0 (0.96)^{100}
= 1 \cdot 1 \cdot 0.01687 = \mathbf{0.0169} \\\\
P(X = 1) &= \binom{100}{1} (0.04)^1 (0.96)^{99}
= 100 \cdot 0.04 \cdot 0.01757 = \mathbf{0.0703} \\\\
P(X = 2) &= \binom{100}{2} (0.04)^2 (0.96)^{98}
= 4950 \cdot 0.0016 \cdot 0.01831 = \mathbf{0.1450} \\\\
P(X = 3) &= \binom{100}{3} (0.04)^3 (0.96)^{97}
= 161700 \cdot 0.000064 \cdot 0.01909 = \mathbf{0.1973} \\\\
P(X = 4) &= \binom{100}{4} (0.04)^4 (0.96)^{96}
= 3921225 \cdot 0.00000256 \cdot 0.01989 = \mathbf{0.1994} \\\\
P(X = 5) &= \binom{100}{5} (0.04)^5 (0.96)^{95}
= 75287520 \cdot 0.0000001024 \cdot 0.02073 = \mathbf{0.1595}
\end{aligned}
$$
...
$$
\begin{aligned}
P(X \leq 5) &= 0.0169 + 0.0703 + 0.1450 + 0.1973 + 0.1994 + 0.1595 \\
&= 0.7884
\end{aligned}
$$

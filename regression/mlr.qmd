...
\; = \;
1.24 \; + \; 0.083\,\text{educ} \; + \; 0.019\,\text{exper}
$$
...
(e) $R^2= 0.9055$
    ...
    An $R^2$ of **0.9055** means that the regression model accounts for **about 90.55 %** of the total variation in hourly wages observed in the sample. Put differently, differences in education and experience explain the vast majority of wage differences across individuals in this dataset, leaving only ≈ 9.45 % of the wage variation unexplained by the model.

    Such a high $R^2$ suggests an excellent in-sample fit. However, we should still be cautious: a high $R^2$ does not guarantee that the model is causal, free of omitted-variable bias, or equally accurate for new data.
:::

...
Assume the first four observations are: (M, 0), (NM, 1), (M, 1), (M, 1) Which we create the following table over:
...
-   Among married individuals, 1496/1550 = 0.965= 96.5% voted while 54 × 1550 = 0.035 =3.5% did not.
...
We split each value from our candy bar weight dataset into 

- **Stem** (e.g., 20, 21, 22, etc.) 
- **Leaf** (the decimal part, such as .1, .2, .3, etc.)

...
=
\frac{(0.934+1.96)^2}
{\dfrac{0.934^2}{17}+\dfrac{1.96^2}{15}}
\approx
\frac{8.38}{0.0513+0.256}
\approx
27.2.
$$
Thus, we use $t_{27} \approx 2.052$ for 95% confidence.
The confidence interval is then given by
$$
-3.5 \pm 2.052 \cdot 1.702
= -3.5 \pm 3.49
\implies [-6.99,\,-0.01].
$$
The 95% confidence interval for the difference in study hours ranges from −6.99 to −0.01 hours. Because the interval does not include zero, there is evidence of a significant difference in average study hours between the two majors.
:::

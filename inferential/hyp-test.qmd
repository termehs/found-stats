...
### Step 2. Test Statistic {.unnumbered}

Specify which test statistic will be used.  
A **test statistic** is a quantity calculated from sample data. Its value forms the basis of our decision.
...
We'll return to this in more detail below.

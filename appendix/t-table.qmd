...
t_table_formatted[ , -1] <- lapply(t_table_formatted[ , -1], function(x) sprintf("%.4f", x))

# Render HTML table with left-aligned caption
kable(t_table_formatted, escape = FALSE, format = "html",
      caption = "One-sided critical t-values for the Student’s t-distribution: P(T &gt; t<sub>&alpha;</sub>) = &alpha;. The last row shows the corresponding standard normal (z) values as degrees of freedom &nu; → &infin;.") %>%
